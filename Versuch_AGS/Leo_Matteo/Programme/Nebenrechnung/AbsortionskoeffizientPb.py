...
daten = 'Versuch_Alpha_Gamma_Spektroskopie/Daten/CSV/AbsobtionskoeffizeintPbKorrektur.csv'
...
#Bennenung des Plots
plt.title('Gefittete Exponentialfunktion bei Blei')
...
#plt.errorbar(df['Dicke'],df['Zaehlrate (1/s)'],xerr= 0.1, yerr=popt[2],capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
