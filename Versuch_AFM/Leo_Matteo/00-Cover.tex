...
\def\uberschrift{AFM} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{WS2021}
\def\datum{20.09.2021}
\def\platz{NW II | Raum 1.2.U1.47   }
\def\betreuer{Marvin Malchau}
\def\groupnr{3}
