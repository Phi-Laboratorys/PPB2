...
df2['Wirkungsgrad'] = -np.multiply(df2['I_MPP (A)'],df2['U_MPP (V)'])/(df2['P_LICHT (sun)']*1000*(0.06**2)*828/282)*11
...
#Fehlerbalken
plt.errorbar(df['P_LICHT (sun)'], abs(df['I_PH (A)']), yerr=0.044,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
