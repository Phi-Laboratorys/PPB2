...
#Fehlerbalken
plt.errorbar(df['P_LICHT (sun)'], df['Wirkungsgrad'], xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.01,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df1['P_LICHT (sun)'], df1['Wirkungsgrad'],xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.01,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df2['P_LICHT (sun)'], df2['Wirkungsgrad'],xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.01,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
...
#Fehlerbalken
plt.errorbar(df['P_LICHT (sun)'], abs(df['I_PH (A)']), xerr = 0.1*df['P_LICHT (sun)']/3,yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
...
#Fehlerbalken
plt.errorbar(df['P_LICHT (sun)'], abs(df['U_OC (V)']),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df1['P_LICHT (sun)'], abs(df1['U_OC (V)']),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df2['P_LICHT (sun)'], abs(df2['U_OC (V)']), xerr = 0.1*df['P_LICHT (sun)']/3,yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
"""
"""
#Benennung des Plots
...
#Fehlerbalken
plt.errorbar(df['P_LICHT (sun)'], abs(df['U_MPP (V)']*df['I_MPP (A)']),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df1['P_LICHT (sun)'], abs(df1['U_MPP (V)']*df1['I_MPP (A)']),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df2['P_LICHT (sun)'], abs(df2['U_MPP (V)']*df2['I_MPP (A)']),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
...
#Fehlerbalken
plt.errorbar(df['P_LICHT (sun)'], abs((df['U_MPP (V)']*df['I_MPP (A)'])/(df['U_OC (V)']*df['I_PH (A)'])),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df1['P_LICHT (sun)'], abs((df1['U_MPP (V)']*df1['I_MPP (A)'])/(df1['U_OC (V)']*df1['I_PH (A)'])),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
plt.errorbar(df2['P_LICHT (sun)'], abs(np.multiply(df2['U_MPP (V)'],df2['I_MPP (A)'])/np.multiply(df2['U_OC (V)'],df2['I_PH (A)'])),xerr = 0.1*df['P_LICHT (sun)']/3, yerr=0.04,capsize = 3, ls = 'None',  color = 'black',elinewidth = 0.5)
