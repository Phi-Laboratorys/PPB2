...
\begin{figure}[h]
	\centering
	\includegraphics[width=7cm,height=5cm]{Auswertung-David/IRF-plot.png}
...
\begin{figure}[h]
	\begin{minipage}{.4\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=\linewidth]{Auswertung-David/c-1-c1-plot.png}
		\caption{CFP-Signal in Kanal 1}
	\end{minipage}
	\hspace{.1\linewidth}% Abstand zwischen Bilder
	\begin{minipage}{.4\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=\linewidth]{Auswertung-David/f-1-c2-plot.png}
...
\begin{figure}[h]
	\begin{minipage}{.4\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=\linewidth]{Auswertung-David/cy-3-c1-plot.png}
		\caption{CFP/YFP-Signal in \\Kanal 1}
	\end{minipage}
	\hspace{.1\linewidth}% Abstand zwischen Bilder
	\begin{minipage}{.4\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=\linewidth]{Auswertung-David/cy-5-c2-plot.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=9cm,height=7cm]{Auswertung-David/faltung-plot.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=9cm,height=7cm]{Auswertung-David/Gauss-fit-plot.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=9cm,height=7cm]{Auswertung-David/faltung-gauss-plot.png}
