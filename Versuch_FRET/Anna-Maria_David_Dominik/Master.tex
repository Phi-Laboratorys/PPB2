...
\newcommand{\Versuchstitel}{Versuch FRET} 
\newcommand{\Versuchsuntertitel}{Förster-Resonanzenergietransfer an biologischen Proben}
\newcommand{\Versuchsdatum}{08.09.2021}
\newcommand{\Semester}{Wintersemester 2021/2022}
\newcommand{\Betreuer}{Dr. Chenyu Jin}
\newcommand{\Bild}{Titelseite/logoUniPDF.pdf}

\newcommand{\Gruppennummer}{6}
\newcommand{\Auswerteperson}{Anna-Maria Pleyer}
\newcommand{\Protokollperson}{David Stadelmann}
\newcommand{\Mesperson}{Dominik Müller}
...
\input{FzV/FragenZurVorbereitung.tex}

%Versuchsdurchführung
\input{Protokoll_Messung/Protokoll.tex}
%Auswertung
...
%Messprotokoll
%\input{Protokoll_Messung/Protokoll.tex}
\input{Anhang/FRET.tex}
%\input{Anhang/fit.tex}
