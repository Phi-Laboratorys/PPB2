...
\usepackage[ragged,raggedright,raggedleft]{sidecap}   
...
\begin{document}
    ...
    \input{01-Einleitung/Einleitung.tex}

    % 2.Kapitel Theorie
    \input{02-Theorie/TheoHintergrund.tex}

    % 3.Kapitel Protokoll
    \input{03-Protokoll/Protokoll.tex}

    % 4.Kapitel Versuchsauswertung
    \input{04-Versuchsauswertung/Versuchsauswertung.tex}

    % 5.Kapitel Fazit
    \input{05-Fazit/Fazit.tex}

    % Anhang
    %\input{06-Anhang/Anhang.tex}
